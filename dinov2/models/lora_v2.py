...
class LoRAMultiHeadAttention(nn.Module):
    ...
    def __init__(
        ...
        if o_lora:
            self.proj = lora.Linear(embed_dim, embed_dim, bias=bias, r=lora_r, lora_alpha=lora_alpha, lora_dropout=lora_dropout)
        else:
...
def lora_replace_attention_layers_vis(
...
if __name__ == "__main__":
    ...
    lora_replace_attention_layers_vis(clip_model.visual.transformer, lora_r=16, lora_alpha=32, lora_dropout=0.1)
    import pdb; pdb.set_trace()
