...
origion_eurosat_attribute = """Generate a list of 20 distinct visual attributes that differentiate a/an {} from other {} in remote sensing images. **MUST Present this list as a Python array**, with each element being a concise phrase but distinctive that describes a unique attribute."""
